...
public class Datos {
    ...
    public static final Lote LOTES[] = {
            new Lote(1, "Lote1", DEPARTAMENTOS[0]),
            new Lote(2, "Lote2", DEPARTAMENTOS[1]),
    ...
    public static final Maquina MAQUINAS[] = {
            ...
            new Maquina(3, 25112021, "P1", LOTES[0]),
            new Maquina(4, 25112021, "P1", LOTES[0]),
            new Maquina(5, 25112021, "P2", LOTES[2]),
    ...
    public static final PoliticaCalidad POLITICAS[] = {
            new PoliticaCalidad(1, "Numero1", 25112021, "Descripcion", "Resultado", OPSCALIDAD[0], REGLAS[1], REGLAS[2]),
            new PoliticaCalidad(2, "Numero2", 25112021, "Descripcion", "Resultado", OPSCALIDAD[1], REGLAS[3], REGLAS[4]),
            new PoliticaCalidad(3, "Numero3", 25112021, "Descripcion", "Resultado", OPSCALIDAD[2], REGLAS[5], REGLAS[1]),
    };
    ...
    public static final Trabajo TRABAJOS[] = {
            ...
            new Trabajo(3, 25112021, 25112021, "Liso", CLIENTES[2], MAQUINAS[3]),
            new Trabajo(4, 25112021, 25112021, "Rugoso", CLIENTES[1], MAQUINAS[1]),
            new Trabajo(5, 25112021, 25112021, "Liso", CLIENTES[2], MAQUINAS[3]),
            new Trabajo(6, 25112021, 25112021, "Liso", CLIENTES[0], MAQUINAS[2]),
            new Trabajo(7, 25112021, 25112021, "Liso", CLIENTES[1], MAQUINAS[1]),
            new Trabajo(8, 25112021, 25112021, "Rugoso", CLIENTES[2], MAQUINAS[1]),
            new Trabajo(9, 25112021, 25112021, "Liso", CLIENTES[0], MAQUINAS[2]),
    };
